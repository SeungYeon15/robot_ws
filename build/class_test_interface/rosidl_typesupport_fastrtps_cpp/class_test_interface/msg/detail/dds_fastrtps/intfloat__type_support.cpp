...
#include "class_test_interface/msg/detail/intfloat__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const class_test_interface::msg::Intfloat *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<class_test_interface::msg::Intfloat *>(
    untyped_ros_message);
...
{
  return &class_test_interface::msg::typesupport_fastrtps_cpp::_Intfloat__handle;
}
