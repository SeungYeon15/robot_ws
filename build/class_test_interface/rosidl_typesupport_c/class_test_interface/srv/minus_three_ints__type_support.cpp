...
static const _MinusThreeInts_Request_type_support_symbol_names_t _MinusThreeInts_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, class_test_interface, srv, MinusThreeInts_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, class_test_interface, srv, MinusThreeInts_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, class_test_interface, srv, MinusThreeInts_Request)() {
  return &::class_test_interface::srv::rosidl_typesupport_c::MinusThreeInts_Request_message_type_support_handle;
}
...
static const _MinusThreeInts_Response_type_support_symbol_names_t _MinusThreeInts_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, class_test_interface, srv, MinusThreeInts_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, class_test_interface, srv, MinusThreeInts_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_class_test_interface
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, class_test_interface, srv, MinusThreeInts_Response)() {
  return &::class_test_interface::srv::rosidl_typesupport_c::MinusThreeInts_Response_message_type_support_handle;
}
...
static const _MinusThreeInts_type_support_symbol_names_t _MinusThreeInts_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, class_test_interface, srv, MinusThreeInts)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, class_test_interface, srv, MinusThreeInts)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, class_test_interface, srv, MinusThreeInts)() {
  return &::class_test_interface::srv::rosidl_typesupport_c::MinusThreeInts_service_type_support_handle;
}
